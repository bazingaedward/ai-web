		...
		return (
			<RadixDialog.Portal>
				...
				<RadixDialog.Content asChild>
					<motion.div
						className={classNames(
							"fixed top-[50%] left-[50%] z-max max-h-[85vh] w-[90vw] min-w-[450px] translate-x-[-50%] translate-y-[-50%] border border-bolt-elements-borderColor rounded-lg bg-bolt-elements-background-depth-2 shadow-lg focus:outline-none overflow-hidden",
							className,
						)}
						initial="closed"
						animate="open"
